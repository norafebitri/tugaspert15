...
<form action="" method="POST">
	<table>
				...
				<tr>
					<td>jenisid</td>
					<td>:</td>
					<td><input type="text" name="jenisid" placeholder="'KTP','SIM','Paspor','dll'" required></td>
				</tr>
				<tr>
					<td>namapasien</td>
					<td>:</td>
				...
				<tr>
					<td>waktudaftar</td>
					<td>:</td>
					<td><input type="text" name="waktudaftar" placeholder="" required></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
...
$insert = mysqli_query($conn, "INSERT INTO pasien VALUES 
 ...
 <!-- footer -->
    <footer><br><br><br><br><br><br><br><br><br><br><br><br><br>
        <div class="container">
            <small style="padding: 10px 0; text-align: center;">Copyright &copy; 2021 - Nama : Nora febitri , Npm : 1955201019</small>
        </div>
    </footer>
</body></center>
</html>